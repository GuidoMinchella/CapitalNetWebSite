      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link to="/privacy-policy" className="block text-gray-400 hover:text-cyan-400 transition-colors duration-200">
                Privacy Policy
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:capitalnet.web@gmail.com" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
                  capitalnet.web@gmail.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-cyan-400 flex-shrink-0" />
                <a href="tel:+393921658427" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
                  392 165 8427
                </a>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-gray-500 text-sm">
            Conforme GDPR - <Link to="/privacy-policy" className="hover:text-cyan-400 transition-colors">Privacy Policy</Link>
          </p>
        </div>
      </div>
    </footer>
