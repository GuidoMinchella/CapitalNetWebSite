...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex items-center justify-center pt-16" style={{ minHeight: 'calc(100vh - 4rem)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-20 sm:mb-12">
      ...
      {/* Slide Indicators - Positioned to avoid overlap with buttons */}
