    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            La Tua <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Identità Digitale</span> È Il Tuo Successo
          </motion.h2>
          ...
          >
            <p className="text-2xl md:text-3xl font-semibold text-white mb-4 leading-tight">
              Nel mondo digitale di oggi, <span className="text-cyan-400">non esistere online significa non esistere</span>
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Il tuo sito web e la tua app non sono solo strumenti tecnologici: sono il volto della tua azienda, 
              il primo punto di contatto con i clienti e la chiave per trasformare visitatori in clienti fedeli.
            </p>
          </motion.div>
          ...
          >
            <p className="text-xl text-gray-300 leading-relaxed">
              <span className="text-white font-semibold">Trasformiamo la tua presenza online</span> in un potente motore di crescita 
              che lavora 24/7 per attrarre, convincere e convertire i tuoi clienti ideali.
            </p>
          </motion.div>
        </div>

        {/* Mobile: Single Impact Section */}
        <div className="md:hidden">
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
            {/* Key Benefits */}
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Presenza Professionale</h4>
                  <p className="text-gray-400 text-sm">Un sito web moderno e ottimizzato che trasmette credibilità e professionalità</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Crescita Costante</h4>
                  <p className="text-gray-400 text-sm">Strategie digitali che generano lead qualificati e aumentano le conversioni</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Fiducia Duratura</h4>
                  <p className="text-gray-400 text-sm">Costruiamo relazioni solide con i tuoi clienti attraverso esperienze digitali eccellenti</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <Link 
                to="/pricing" 
                className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105"
              >
                <span>Scopri i nostri pacchetti</span>
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            <StatCard
              ...
              chart={<TimelineGraph 
                title="Crescita delle Vendite"
                subtitle="Aumento medio dopo il lancio del sito web"
              />}
            />
          </motion.div>
        </div>
