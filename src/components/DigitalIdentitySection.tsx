      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Trasformiamo la presenza online delle aziende in potenti strumenti di crescita. 
            Scopri come una strategia digitale mirata può aumentare le tue vendite e costruire fiducia duratura.
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
            ...
            <div className="text-center mb-8">
              <div className="relative inline-block">
                <div className="w-32 h-32 mx-auto bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full flex items-center justify-center border border-cyan-400/30 backdrop-blur-sm">
                ...
                <div className="absolute -bottom-2 -left-2 w-4 h-4 bg-yellow-400 rounded-full animate-pulse delay-300"></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-300">Vendite Online</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400 mb-1">85%</div>
                <div className="text-sm text-gray-300">Fiducia Cliente</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400 mb-1">3x</div>
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center space-x-2 text-cyan-400 font-medium">
                <span>Scopri come crescere</span>
          ...
          >
            <StatCard
              ...
              chart={<CircularChart 
                ...
                subtitle="dei consumatori cerca online prima di acquistare"
              />}
            />
          </motion.div>
